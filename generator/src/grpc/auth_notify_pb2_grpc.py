...
class AuthNotifyStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserData = channel.unary_unary(
            "/google.golang.org.AuthNotify/GetUserData",
            request_serializer=auth__notify__pb2.UserDataRequest.SerializeToString,
            response_deserializer=auth__notify__pb2.UserDataResponse.FromString,
        )
...
def add_AuthNotifyServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "GetUserData": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=auth__notify__pb2.UserDataRequest.FromString,
...
class AuthNotify(object):
    ...
    def GetUserData(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/google.golang.org.AuthNotify/GetUserData",
            auth__notify__pb2.UserDataRequest.SerializeToString,
            auth__notify__pb2.UserDataResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
