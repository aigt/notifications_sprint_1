...
Админ-панель при регистрации новой серии в базе фильмов отпровляет задачу в API сервиса уведомлений на отправку мгновенных массовых уведомлений с указаним типа оповещения подписка и названия сериала.


### Ваш комментарий лайкнули

UGC сервис отпровляет задачу в API сервиса уведомлений на отправку не срочного персонального уведомления с указаним типа оповещения лайк комментария и указанием UUID пользователя и комментария.


### Реклама киноновинок

Админ-панель при регистрации киноновинок отпровляет задачу в API сервиса уведомлений на отправку не срочного массового уведомления с указаним типа оповещения новинки и указанием UUID новинки.
...
Админ-панель отпровляет задачу в API сервиса уведомлений на отправку мгновенных или не срочных персональных уведомлений с указаним типа оповещения рассылка.
...
```jsonc
{
  ...
  "meta": {
    ...
    // Массовость оповещения: массовое|индивидуальное|welcome
    "scale": "bulk|individual|welcome",
